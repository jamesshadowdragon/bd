    ...
    <style>
        * {
        ...
        body::before {
            ...
            width: 100%;
            height: 100%;
            background: radial-gradient(circle at 20% 30%, rgba(200, 0, 0, 0.12) 0%, transparent 55%),
                        radial-gradient(circle at 80% 70%, rgba(150, 0, 0, 0.08) 0%, transparent 50%);
            pointer-events: none;
            z-index: 0;
        }
        ...
        body::after {
            ...
            width: 100%;
            height: 100%;
            background: url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ff0000' fill-opacity='0.03'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
            pointer-events: none;
            z-index: 0;
        }
        ...
        .logo-circle {
            ...
            align-items: center;
            justify-content: center;
            box-shadow: 0 10px 40px -5px rgba(200, 0, 0, 0.5);
        ...
        .brand-name {
            font-size: 44px;
            font-weight: 900;
            background: linear-gradient(135deg, #ff2222 0%, #880000 50%, #ff4444 100%);
        ...
        .main-card {
            ...
            padding: 32px 28px;
            margin-bottom: 24px;
            box-shadow: 0 20px 50px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(255, 50, 50, 0.05);
        }
        ...
        .submit-btn:hover:not(:disabled) {
            ...
            box-shadow: 0 10px 30px -5px rgba(200, 0, 0, 0.5);
        }
        ...
        @media (max-width: 480px) {
            ...
            .mode-tab { padding: 10px 10px; font-size: 12px; }
...
<div id="discordPopup">
    ...
    <div class="discord-stats">
        <div class="stat-box">
            <div class="stat-value"><span class="online-dot"></span><span id="popOnlineCount">...</span></div>
            <div class="stat-label">Online</div>
        </div>
        <div class="stat-box">
            <div class="stat-value"><span class="total-dot"></span><span id="popMemberCount">...</span></div>
